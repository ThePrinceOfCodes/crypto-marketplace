...
import { ViewPopUpModalRef } from "./types";
import { useLocale } from "locale";
import { htmlIds } from "@cypress/utils/ids";

function ViewPopUpModal(
  { report }: { report: { imageUrl: string | undefined } },
  ref: Ref<ViewPopUpModalRef>,
) {
...
export default forwardRef(ViewPopUpModal);
